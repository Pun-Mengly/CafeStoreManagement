...
public class UseTemplateXLS
{
    ...
    public byte[] Edition(Stream streamTemplate, ItemDetailResponse[] data)
    {
    ...
    public async Task<byte[]> FillIn(HttpClient client, Stream streamTemplate, ItemDetailResponse[] data, string existingXLS)
    {
        // Open the Templace
        var template = new XLTemplate(streamTemplate);
        // Send Data
